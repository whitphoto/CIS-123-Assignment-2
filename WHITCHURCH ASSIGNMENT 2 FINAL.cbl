       ...
       evaluate IN-DAY 
           when "M" move 1 to d-sub
           when "T" move 2 TO D-SUB
           WHEN "W" MOVE 3 TO D-SUB
           WHEN "X" MOVE 4 TO D-SUB
           WHEN "F" MOVE 5 TO D-SUB
      ...
      *write output-rec from wday(p-sub, d-sub)
       ...
       set d-sub to ws-day
           ...
           set p-sub to ws-period
               if wday(p-sub, d-sub) equal to spaces perform 400-print
